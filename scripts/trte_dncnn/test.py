...
def main():
    ...
    exps = read_test("exps/trte_dncnn/test.cfg",
                     ".cache_io_exps/trte_dncnn/test",reset=refresh,skip_dne=refresh)
    exps,uuids = cache_io.get_uuids(exps,".cache_io/trte_dncnn/test",
    ...
    results = cache_io.run_exps(exps,test.run,uuids=uuids,preset_uuids=True,
                                name=".cache_io/trte_dncnn/test",
                                version="v1",skip_loop=False,
                                clear=False,enable_dispatch="slurm",
                                records_fn=".cache_io_pkl/trte_dncnn/test.pkl",
